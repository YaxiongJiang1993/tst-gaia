// Generated from /home/david/flower/tst-gaia/tst-gaia-common-test/src/main/java/com/davih/tst/common/test/antr/mysql/MySqlLexer.g4 by ANTLR 4.13.2
...
public class MySqlLexer extends Lexer {
	...
	public static final int
		...
		DISJOINT=871, DISTANCE=872, ELT=873, ENCODE=874, ENCRYPT=875, ENDPOINT=876, 
		ENGINE_ATTRIBUTE=877, ENVELOPE=878, EQUALS=879, EXP=880, EXPORT_SET=881, 
		EXTERIORRING=882, EXTRACTVALUE=883, FIELD=884, FIND_IN_SET=885, FLOOR=886, 
		FORMAT=887, FOUND_ROWS=888, FROM_BASE64=889, FROM_DAYS=890, FROM_UNIXTIME=891, 
		GEOMCOLLFROMTEXT=892, GEOMCOLLFROMWKB=893, GEOMETRYCOLLECTIONFROMTEXT=894, 
		GEOMETRYCOLLECTIONFROMWKB=895, GEOMETRYFROMTEXT=896, GEOMETRYFROMWKB=897, 
		GEOMETRYN=898, GEOMETRYTYPE=899, GEOMFROMTEXT=900, GEOMFROMWKB=901, GET_FORMAT=902, 
		GET_LOCK=903, GLENGTH=904, GREATEST=905, GTID_SUBSET=906, GTID_SUBTRACT=907, 
		HEX=908, IFNULL=909, INET6_ATON=910, INET6_NTOA=911, INET_ATON=912, INET_NTOA=913, 
		INSTR=914, INTERIORRINGN=915, INTERSECTS=916, ISCLOSED=917, ISEMPTY=918, 
		ISNULL=919, ISSIMPLE=920, IS_FREE_LOCK=921, IS_IPV4=922, IS_IPV4_COMPAT=923, 
		IS_IPV4_MAPPED=924, IS_IPV6=925, IS_USED_LOCK=926, LAST_INSERT_ID=927, 
		LCASE=928, LEAST=929, LENGTH=930, LINEFROMTEXT=931, LINEFROMWKB=932, LINESTRINGFROMTEXT=933, 
		LINESTRINGFROMWKB=934, LN=935, LOAD_FILE=936, LOCATE=937, LOG=938, LOG10=939, 
		LOG2=940, LOWER=941, LPAD=942, LTRIM=943, MAKEDATE=944, MAKETIME=945, 
		MAKE_SET=946, MASTER_POS_WAIT=947, MBRCONTAINS=948, MBRDISJOINT=949, MBREQUAL=950, 
		MBRINTERSECTS=951, MBROVERLAPS=952, MBRTOUCHES=953, MBRWITHIN=954, MD5=955, 
		MLINEFROMTEXT=956, MLINEFROMWKB=957, MONTHNAME=958, MPOINTFROMTEXT=959, 
		MPOINTFROMWKB=960, MPOLYFROMTEXT=961, MPOLYFROMWKB=962, MULTILINESTRINGFROMTEXT=963, 
		MULTILINESTRINGFROMWKB=964, MULTIPOINTFROMTEXT=965, MULTIPOINTFROMWKB=966, 
		MULTIPOLYGONFROMTEXT=967, MULTIPOLYGONFROMWKB=968, NAME_CONST=969, NULLIF=970, 
		NUMGEOMETRIES=971, NUMINTERIORRINGS=972, NUMPOINTS=973, OCT=974, OCTET_LENGTH=975, 
		ORD=976, OVERLAPS=977, PERIOD_ADD=978, PERIOD_DIFF=979, PI=980, POINTFROMTEXT=981, 
		POINTFROMWKB=982, POINTN=983, POLYFROMTEXT=984, POLYFROMWKB=985, POLYGONFROMTEXT=986, 
		POLYGONFROMWKB=987, POW=988, POWER=989, QUOTE=990, RADIANS=991, RAND=992, 
		RANDOM=993, RANDOM_BYTES=994, RELEASE_LOCK=995, REVERSE=996, ROUND=997, 
		ROW_COUNT=998, RPAD=999, RTRIM=1000, SEC_TO_TIME=1001, SECONDARY_ENGINE_ATTRIBUTE=1002, 
		SESSION_USER=1003, SHA=1004, SHA1=1005, SHA2=1006, SCHEMA_NAME=1007, SIGN=1008, 
		SIN=1009, SLEEP=1010, SOUNDEX=1011, SQL_THREAD_WAIT_AFTER_GTIDS=1012, 
		SQRT=1013, SRID=1014, STARTPOINT=1015, STRCMP=1016, STR_TO_DATE=1017, 
		ST_AREA=1018, ST_ASBINARY=1019, ST_ASTEXT=1020, ST_ASWKB=1021, ST_ASWKT=1022, 
		ST_BUFFER=1023, ST_CENTROID=1024, ST_CONTAINS=1025, ST_CROSSES=1026, ST_DIFFERENCE=1027, 
		ST_DIMENSION=1028, ST_DISJOINT=1029, ST_DISTANCE=1030, ST_ENDPOINT=1031, 
		ST_ENVELOPE=1032, ST_EQUALS=1033, ST_EXTERIORRING=1034, ST_GEOMCOLLFROMTEXT=1035, 
		ST_GEOMCOLLFROMTXT=1036, ST_GEOMCOLLFROMWKB=1037, ST_GEOMETRYCOLLECTIONFROMTEXT=1038, 
		ST_GEOMETRYCOLLECTIONFROMWKB=1039, ST_GEOMETRYFROMTEXT=1040, ST_GEOMETRYFROMWKB=1041, 
		ST_GEOMETRYN=1042, ST_GEOMETRYTYPE=1043, ST_GEOMFROMTEXT=1044, ST_GEOMFROMWKB=1045, 
		ST_INTERIORRINGN=1046, ST_INTERSECTION=1047, ST_INTERSECTS=1048, ST_ISCLOSED=1049, 
		ST_ISEMPTY=1050, ST_ISSIMPLE=1051, ST_LINEFROMTEXT=1052, ST_LINEFROMWKB=1053, 
		ST_LINESTRINGFROMTEXT=1054, ST_LINESTRINGFROMWKB=1055, ST_NUMGEOMETRIES=1056, 
		ST_NUMINTERIORRING=1057, ST_NUMINTERIORRINGS=1058, ST_NUMPOINTS=1059, 
		ST_OVERLAPS=1060, ST_POINTFROMTEXT=1061, ST_POINTFROMWKB=1062, ST_POINTN=1063, 
		ST_POLYFROMTEXT=1064, ST_POLYFROMWKB=1065, ST_POLYGONFROMTEXT=1066, ST_POLYGONFROMWKB=1067, 
		ST_SRID=1068, ST_STARTPOINT=1069, ST_SYMDIFFERENCE=1070, ST_TOUCHES=1071, 
		ST_UNION=1072, ST_WITHIN=1073, ST_X=1074, ST_Y=1075, STRING_TO_VECTOR=1076, 
		SUBDATE=1077, SUBSTRING_INDEX=1078, SUBTIME=1079, SYSTEM_USER=1080, TAN=1081, 
		TIMEDIFF=1082, TIMESTAMPADD=1083, TIMESTAMPDIFF=1084, TIME_FORMAT=1085, 
		TIME_TO_SEC=1086, TOUCHES=1087, TO_BASE64=1088, TO_DAYS=1089, TO_SECONDS=1090, 
		TP_CONNECTION_ADMIN=1091, UCASE=1092, UNCOMPRESS=1093, UNCOMPRESSED_LENGTH=1094, 
		UNHEX=1095, UNIX_TIMESTAMP=1096, UPDATEXML=1097, UPPER=1098, UUID=1099, 
		UUID_SHORT=1100, VALIDATE_PASSWORD_STRENGTH=1101, VECTOR_DIM=1102, VECTOR_TO_STRING=1103, 
		...
		VAR_ASSIGN=1113, PLUS_ASSIGN=1114, MINUS_ASSIGN=1115, MULT_ASSIGN=1116, 
		DIV_ASSIGN=1117, MOD_ASSIGN=1118, AND_ASSIGN=1119, XOR_ASSIGN=1120, OR_ASSIGN=1121, 
		STAR=1122, DIVIDE=1123, MODULE=1124, PLUS=1125, MINUS=1126, DIV=1127, 
		MOD=1128, EQUAL_SYMBOL=1129, GREATER_SYMBOL=1130, LESS_SYMBOL=1131, EXCLAMATION_SYMBOL=1132, 
		BIT_NOT_OP=1133, BIT_OR_OP=1134, BIT_AND_OP=1135, BIT_XOR_OP=1136, DOT=1137, 
		LR_BRACKET=1138, RR_BRACKET=1139, COMMA=1140, SEMI=1141, AT_SIGN=1142, 
		ZERO_DECIMAL=1143, ONE_DECIMAL=1144, TWO_DECIMAL=1145, SINGLE_QUOTE_SYMB=1146, 
		DOUBLE_QUOTE_SYMB=1147, REVERSE_QUOTE_SYMB=1148, COLON_SYMB=1149, CHARSET_REVERSE_QOUTE_STRING=1150, 
		...
		HOST_IP_ADDRESS=1163, LOCAL_ID=1164, GLOBAL_ID=1165, ERROR_RECONGNIGION=1166;
	public static final int
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"SUBDATE", "SUBSTRING_INDEX", "SUBTIME", "SYSTEM_USER", "TAN", "TIMEDIFF", 
			...
			"UPPER", "UUID", "UUID_SHORT", "VALIDATE_PASSWORD_STRENGTH", "VECTOR_DIM", 
			"VECTOR_TO_STRING", "VERSION", "WAIT_UNTIL_SQL_THREAD_AFTER_GTIDS", "WEEKDAY", 
			"WEEKOFYEAR", "WEIGHT_STRING", "WITHIN", "YEARWEEK", "Y_FUNCTION", "X_FUNCTION", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'SEC_TO_TIME'", "'SECONDARY_ENGINE_ATTRIBUTE'", "'SESSION_USER'", "'SHA'", 
			"'SHA1'", "'SHA2'", "'SCHEMA_NAME'", "'SIGN'", "'SIN'", "'SLEEP'", "'SOUNDEX'", 
